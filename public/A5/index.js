...
let loggedIn = true;
// if loggedIn is true greeting is welcome if not please login
...
// mix and match array can have diff types arrays in array
let variableArray1 = [
    functionScoped,
    blockScoped,
    constant1,
...
const passingGrades = grades.filter(grade => grade > 65);
...
const anotherLineItem1 = $("<li>Line item 3 to the top</li>");

const ul = $('#append-new-elements');
ul.append(newLineItem);
ul.append(anotherLineItem);
ul.prepend(anotherLineItem1);
...
/* this also works
parent1.css({'background-color':'red', 'color':'white'});
*/
const parent = $('#parent');
